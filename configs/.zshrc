...
# Since some of the tools somehow uses polish locale
...
# combine pdf by ghostscript. Usage 👉 cpdf merged.pdf file1.pdf file2.pdf file3.pdf
cpdf() {
  gs -q -dNOPAUSE -dBATCH -sDEVICE=pdfwrite -sOutputFile="$1" "${@:2}"
}

# check what is runnin on port. Usage 👉 onport 8080
onport() {
  lsof -i tcp:$1
}
